...
/****** xvidcore/main/xvid_encore *******************************************
*
*   NAME
*      xvid_encore -- Description
*
*   SYNOPSIS
...
int _XvidCore_xvid_encore(struct XvidCoreIFace *Self, void *handle, int opt, void *param1, void *param2) {
	return xvid_encore(handle, opt, param1, param2);
}
